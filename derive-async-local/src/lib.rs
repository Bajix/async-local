...
/// Derive [AsRef](https://doc.rust-lang.org/std/convert/trait.AsRef.html)<[`Context<T>`](https://docs.rs/async-local/latest/async_local/trait.Context.html)> and [AsContext](https://docs.rs/async-local/latest/async_local/trait.AsContext.html) for struct
