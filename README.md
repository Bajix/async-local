...
The only requirement for async runtimes to be compatible with [async-local](https://crates.io/crates/async-local) is that upon shutdown pending async tasks aren't dropped by thread local destructors.
